...
class CollaborationsControllerTest < ActionController::TestCase
  ...
  test "should create collaboration" do
    assert_difference('Collaboration.count') do
      post :create, collaboration: { country: @collaboration.country, county: @collaboration.county, desc: @collaboration.desc, name: @collaboration.name, state: @collaboration.state }
    end
  ...
  test "should update collaboration" do
    patch :update, id: @collaboration, collaboration: { country: @collaboration.country, county: @collaboration.county, desc: @collaboration.desc, name: @collaboration.name, state: @collaboration.state }
    assert_redirected_to collaboration_path(assigns(:collaboration))
  end
